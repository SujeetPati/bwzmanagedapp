		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BWZ poc app",
									"targetURL": "#comshellpocapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comshellpocapp-display": {
								"semanticObject": "comshellpocapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comshell.pocapp",
									"url": sap.ui.require.toUrl("comshell/pocapp")
								}
							}
						}
					}
